...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 pb-20 font-sans">
      {/* Header - Versione Originale */}
      <header className="border-b border-slate-100 mb-12">
      ...
      <main className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white p-6 rounded-xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-gray-100">
            <h3 className="font-bold text-base text-gray-700 mb-6 flex items-center gap-2">
            ...
            <div className="flex flex-col gap-4">
              <Dropzone
                ...
                colorClass="border-indigo-100 hover:bg-indigo-50/30 hover:border-indigo-300"
              />
              ...
              <Dropzone
                ...
                colorClass="border-blue-100 hover:bg-blue-50/30 hover:border-blue-300"
              />
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-gray-100">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="p-4 bg-gray-50/50 rounded-lg border border-gray-100">
                <h4 className="text-xs font-bold text-gray-600 mb-3 uppercase tracking-wider">Configurazione Script di Copia (.bat)</h4>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 text-sm border border-gray-200 rounded-md focus:ring-1 focus:ring-blue-400 outline-none transition-all"
                    />
          ...
          <button
            ...
            className={`
              ...
              ${(!dbFile || !bomFile)
                ...
                : 'bg-slate-300 text-slate-700 hover:bg-slate-400 active:scale-95 shadow-sm'}
            `}
          >
            {isProcessing ? (
